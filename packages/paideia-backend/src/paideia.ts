...
import * as courseActivityModuleLinkManagement from "./internal/course-activity-module-link-management";
import * as courseCategoryManagement from "./internal/course-category-management";
import * as courseManagement from "./internal/course-management";
import * as courseSectionManagement from "./internal/course-section-management";
