...
type QuizGradingLoaderData = Extract<
	Route.ComponentProps["loaderData"],
	{ gradingModuleType: "quiz" }
>;

type QuizSubmission = QuizGradingLoaderData["gradingSubmission"];
...
export interface QuizGradingViewProps {
	...
	module: QuizGradingLoaderData["module"];
	moduleSettings: QuizGradingLoaderData["moduleSettings"];
	course: QuizGradingLoaderData["course"];
