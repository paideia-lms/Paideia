...
export default function CourseModulesPage({ loaderData }: Route.ComponentProps) {
    ...
    return (
        <Container size="lg" py="xl">
            ...
            <meta property="og:title" content={`${course.title} - Modules | Paideia LMS`} />
            <meta property="og:description" content={`${course.title} modules management`} />
