...
import { badRequest, ForbiddenResponse, ok, StatusCode, unauthorized } from "~/utils/responses";
...
export async function clientAction({ serverAction }: Route.ClientActionArgs) {
  ...
  if (actionData?.status === StatusCode.Ok) {
    notifications.show({ title: "Success", message: "Courses updated", color: "green" });
  }
