...
export default function CreateFirstUserView({ loaderData }: Route.ComponentProps) {
...
interface CreateFirstUserClientProps {
}

export function CreateFirstUserClient({ }: CreateFirstUserClientProps) {
