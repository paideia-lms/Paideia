import { Button, Container, List, Paper, Stack, Table, Text, Title } from "@mantine/core";
...
import { badRequest, NotFoundResponse, ok, StatusCode } from "~/utils/responses";
...
const actionSchema = z.discriminatedUnion("intent", [grantAccessSchema, revokeAccessSchema]);
...
function LinkedCoursesSection({ links, linkedCourses }: LinkedCoursesSectionProps) {
    return (
...
export default function UserModuleEditAccess() {
    const { module, linkedCourses, links, grants, instructors } = useLoaderData<typeof loader>();
