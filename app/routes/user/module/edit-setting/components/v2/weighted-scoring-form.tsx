...
export function WeightedScoringForm({
    ...
    const form = useForm({
        initialValues: {
            ...
            pointsPerCorrect: scoring.mode === "all-or-nothing" ? 0 : scoring.pointsPerCorrect ?? 0,
            penaltyPerIncorrect: scoring.mode === "partial-with-penalty" ? scoring.penaltyPerIncorrect ?? 0 : 0,
        },
    });
