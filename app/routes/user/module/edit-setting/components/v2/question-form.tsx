...
import { IconChevronDown, IconChevronUp, IconEye, IconGripVertical } from "@tabler/icons-react";
    ...
    return (
        <>
            ...
            <Modal
                ...
                title={
                    `Preivew Question ${questionIndex + 1}: ${QuestionTypeLabels[question.type]}`
                }
                size="lg"
            >
                <Stack gap="md">
