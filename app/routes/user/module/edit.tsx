...
import { badRequest, NotFoundResponse, UnauthorizedResponse } from "~/utils/responses";
...
export default function EditModulePage() {
    ...
    const form = useForm<ActivityModuleFormValues>({
        ...
        initialValues: {
            ...
            quizGradingType: (quizData?.gradingType as "automatic" | "manual") || "automatic",
            // Discussion fields
