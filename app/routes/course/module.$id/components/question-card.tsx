...
function UnflagButton({
    ...
    const { submit: unflagQuestion, isLoading: isUnflagging } = useUnflagQuizQuestion();
...
function SavedAnswerBadge({
    ...
    const showRemoveButton = !readonly && Boolean(moduleLinkId) && Boolean(submissionId);
...
export function QuestionCard({
    ...
    const handleAnswerChange = (value: unknown) => {
        ...
        if (!readonly && moduleLinkId && submissionId) {
            ...
            const typedAnswer = convertToTypedAnswer(question, value as QuestionAnswer);
        ...
        <Paper withBorder p="md" radius="sm">
            <Stack gap="md">
                ...
                <Group justify="space-between" align="flex-start">
                    ...
                    <Group gap="xs">
                        {!readonly && moduleLinkId && submissionId && (
                            isFlagged ? (
                                <UnflagButton
                                    questionId={question.id}
                                    moduleLinkId={moduleLinkId}
