...
export default function SectionPage({ loaderData }: Route.ComponentProps) {
    ...
    return (
        <Container size="xl" py="xl">
            <title>{section.title} | {course.title} | Paideia LMS</title>
            <meta name="description" content={`View ${section.title} section in ${course.title}`} />
            ...
            <Stack gap="xl">
                ...
                <Paper withBorder shadow="sm" p="xl">
                    ...
                    {section.description && (
                        <Text mb="md">{section.description}</Text>
                    )}
                    <Text>This section is part of the course structure. Use the course structure tree to manage modules and subsections within this section.</Text>
