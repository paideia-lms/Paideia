        ...
        <Box p="md">
            {isRouteErrorResponse(error) ? (
                <>
                    ...
                    <Text>{typeof error.data === "string" ? error.data : JSON.stringify(error.data)}</Text>
                </>
                ...
                <Title order={1} c="red">Unknown Error</Title>
            )}
        </Box>
    );
}
        ...
        <Box className="admin-dashboard">
            ...
            <Tabs value={activeTab} onChange={(value) => {
                ...
                <Tabs.Panel value="general" pt="xl">
                    <Stack gap="lg">
                        {Object.entries(adminTabs.general.sections).map(([sectionKey, section]) => (
                            <Box key={sectionKey}>
                                <Title order={2} mb="md">
                                    {section.title}
                                </Title>
                ...
                <Tabs.Panel value="users" pt="xl">
                    <Stack gap="lg">
                        {Object.entries(adminTabs.users.sections).map(([sectionKey, section]) => (
                            <Box key={sectionKey}>
                                <Title order={2} mb="md">
                                    {section.title}
                                </Title>
                ...
                <Tabs.Panel value="courses" pt="xl">
                    <Stack gap="lg">
                        {Object.entries(adminTabs.courses.sections).map(([sectionKey, section]) => (
                            <Box key={sectionKey}>
                                <Title order={2} mb="md">
                                    {section.title}
                                </Title>
                ...
                <Tabs.Panel value="grades" pt="xl">
                    <Stack gap="lg">
                        {Object.entries(adminTabs.grades.sections).map(([sectionKey, section]) => (
                            <Box key={sectionKey}>
                                <Title order={2} mb="md">
                                    {section.title}
                                </Title>
                ...
                <Tabs.Panel value="plugins" pt="xl">
                    <Stack gap="lg">
                        {Object.entries(adminTabs.plugins.sections).map(([sectionKey, section]) => (
                            <Box key={sectionKey}>
                                <Title order={2} mb="md">
                                    {section.title}
                                </Title>
                ...
                <Tabs.Panel value="appearance" pt="xl">
                    <Stack gap="lg">
                        {Object.entries(adminTabs.appearance.sections).map(([sectionKey, section]) => (
                            <Box key={sectionKey}>
                                <Title order={2} mb="md">
                                    {section.title}
                                </Title>
                ...
                <Tabs.Panel value="server" pt="xl">
                    <Stack gap="lg">
                        {Object.entries(adminTabs.server.sections).map(([sectionKey, section]) => (
                            <Box key={sectionKey}>
                                <Title order={2} mb="md">
                                    {section.title}
                                </Title>
                ...
                <Tabs.Panel value="reports" pt="xl">
                    <Stack gap="lg">
                        {Object.entries(adminTabs.reports.sections).map(([sectionKey, section]) => (
                            <Box key={sectionKey}>
                                <Title order={2} mb="md">
                                    {section.title}
                                </Title>
                ...
                <Tabs.Panel value="development" pt="xl">
                    <Stack gap="lg">
                        {Object.entries(adminTabs.development.sections).map(([sectionKey, section]) => (
                            <Box key={sectionKey}>
                                <Title order={2} mb="md">
                                    {section.title}
                                </Title>
