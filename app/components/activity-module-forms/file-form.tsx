import { ActionIcon, Anchor, Button, Group, Stack, Text, Textarea, Title, Tooltip } from "@mantine/core";
...
import type { ActivityModuleFormValues, FileModuleFormValues } from "~/utils/activity-module-schema";
...
export function FileForm({ initialValues, onSubmit, uploadLimit, existingMedia = [], isLoading }: FileFormProps) {
