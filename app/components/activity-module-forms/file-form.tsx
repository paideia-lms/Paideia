import { ActionIcon, Anchor, Group, Stack, Text, Textarea, Title, Tooltip } from "@mantine/core";
...
export function FileForm({ form, uploadLimit, existingMedia = [] }: FileFormProps) {
