                    ...
                    <DragOverlay>
                        {activeItem ? (
                            activeItem.type === "pageBreak" ? (
                                <Paper withBorder p="sm" radius="md" bg="gray.0" style={{ cursor: 'grabbing' }}>
                                    <Group justify="space-between">
                                        <Group gap="xs">
                                            <IconGripVertical size={16} />
                                            <IconSeparator size={20} />
                                ...
                                <Card withBorder radius="md" p="md" style={{ cursor: 'grabbing' }}>
                                    <Group justify="space-between" wrap="nowrap">
                                        <Group gap="xs" style={{ flex: 1 }}>
                                            ...
                                            <Text fw={500} size="sm">
                                                Question {items
                                                    .slice(0, items.findIndex((i) =>
                                                        i.type === "question" && i.data.id === activeItem.data.id
                                                    ) + 1)
                                                    .filter((i) => i.type === "question").length
                                                }: {
                                                    activeItem.data.type === "multiple-choice" ? "Multiple Choice" :
                                                        activeItem.data.type === "short-answer" ? "Short Answer" : "Long Answer"
                                                }
                                            </Text>
    ...
    return (
        <Stack gap="md">
            <TextInput
                ...
                onChange={(e) =>
                    onChange({ ...nestedQuiz, title: e.currentTarget.value })
                }
            />
            ...
            <Textarea
                ...
                onChange={(e) =>
                    onChange({ ...nestedQuiz, description: e.currentTarget.value })
                }
                minRows={2}
            />
