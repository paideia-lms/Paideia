 ...
 */
export function tryAssignCategoryRole(args: AssignCategoryRoleArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryRevokeCategoryRole(args: RevokeCategoryRoleArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryGetUserCategoryRoles(args: GetUserCategoryRolesArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryCheckUserCategoryRole(args: CheckUserCategoryRoleArgs) {
	return Result.try(
		async () => {
			const {
						payload,
