 ...
 */
export function tryTransferActivityModuleOwnership(
 ...
 */
export function tryFindGrantsByActivityModule(
	args: FindGrantsByActivityModuleArgs,
) {
	return Result.try(
		async () => {
...
export function tryFindAutoGrantedModulesForInstructor(
	args: FindAutoGrantedModulesForInstructorArgs,
) {
	return Result.try(
		async () => {
