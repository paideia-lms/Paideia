 ...
 */
export function tryGrantAccessToActivityModule(args: GrantAccessArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryRevokeAccessFromActivityModule(args: RevokeAccessArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryTransferActivityModuleOwnership(args: TransferOwnershipArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryFindGrantsByActivityModule(args: FindGrantsByActivityModuleArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryFindInstructorsForActivityModule(args: FindInstructorsForActivityModuleArgs) {
	return Result.try(
		async () => {
...
export function tryFindAutoGrantedModulesForInstructor(args: FindAutoGrantedModulesForInstructorArgs) {
	return Result.try(
		async () => {
