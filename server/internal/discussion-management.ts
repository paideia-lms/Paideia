 ...
 */
export function tryCreateDiscussionSubmission(args: CreateDiscussionSubmissionArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryUpdateDiscussionSubmission(args: UpdateDiscussionSubmissionArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryGetDiscussionSubmissionById(args: GetDiscussionSubmissionByIdArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryGetDiscussionThreadsWithAllReplies(args: GetDiscussionThreadsWithAllRepliesArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryUpvoteDiscussionSubmission(args: UpvoteDiscussionSubmissionArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryRemoveUpvoteDiscussionSubmission(args: RemoveUpvoteDiscussionSubmissionArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryListDiscussionSubmissions(args: ListDiscussionSubmissionsArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryGradeDiscussionSubmission(args: GradeDiscussionSubmissionArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryDeleteDiscussionSubmission(args: DeleteDiscussionSubmissionArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryGetDiscussionThreadWithReplies(args: tryGetDiscussionThreadWithRepliesArgs) {
	return Result.try(
		async () => {
			const {
						payload,
