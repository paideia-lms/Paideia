 ...
 */
export function tryCreateGradebookItem(args: CreateGradebookItemArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryValidateOverallWeightTotal(args: ValidateOverallWeightTotalArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryUpdateGradebookItem(args: UpdateGradebookItemArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryFindGradebookItemById(args: TryFindGradebookItemByIdArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryDeleteGradebookItem(args: DeleteGradebookItemArgs) {
	return Result.try(
		async () => {
			const { payload, itemId, req, overrideAccess = false } = args;
 ...
 */
export function tryGetGradebookItemsInOrder(args: TryGetGradebookItemsInOrderArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryGetCategoryItems(args: TryGetCategoryItemsArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryGetNextItemSortOrder(args: TryGetNextItemSortOrderArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryReorderItems(args: TryReorderItemsArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryGetItemsWithUserGrades(args: TryGetItemsWithUserGradesArgs) {
	return Result.try(
		async () => {
			const {
						payload,
 ...
 */
export function tryFindGradebookItemByCourseModuleLink(args: FindGradebookItemByCourseModuleLinkArgs) {
	return Result.try(
		async () => {
