 ...
 */
export function tryGetMediaBufferFromFilename(args: GetMediaBufferFromFilenameArgs) {
	return Result.try(
		async () => {
 ...
 */
export function tryGetMediaStreamFromFilename(args: GetMediaStreamFromFilenameArgs) {
	return Result.try(
		async () => {
			const {
						payload,
