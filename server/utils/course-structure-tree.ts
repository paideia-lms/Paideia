import type { CourseStructure, CourseStructureSection, CourseStructureItem } from "../internal/course-section-management";
...
function generateSectionTree(
    ...
    const sectionLine = `${prefix}${connector}${section.title} (order: ${section.order}, contentOrder: ${section.contentOrder})`;
