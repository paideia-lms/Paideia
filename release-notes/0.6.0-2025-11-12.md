...
> [!CAUTION]
> **CRITICAL: DO NOT INSTALL v0.6.0**
> 
> This release contains a critical migration bug that prevents the server from starting. The database migration fails during the upgrade process, causing complete deployment failure.
> 
> **Action Required:**
> - **If you have not upgraded yet**: Skip v0.6.0 and upgrade directly to [v0.6.1](./0.6.1-2025-11-13.md) instead
> - **If you already attempted v0.6.0**: Your system should have automatically rolled back to v0.5.6 (thanks to Payload's rollback mechanism). Upgrade directly to v0.6.1 - no data loss should have occurred.
> 
> **Incident Report**: See [Incident Report: v0.6.0 Migration Failure](./incidents/2025-11-12-v0-6-0-migration-failure.md) for full details.
...
**Benefits**:
- ✅ Centralized media management for users
- ✅ Foundation for media uploads in assignments, notes, and other content
- ✅ Clear visibility into storage usage
- ✅ Easy file organization and reuse
- ✅ Consistent user experience across the platform

### ⚙️ Site Policies and Upload Limits
...
**Administration**:
- Configure via Admin → Server → Site Policies
...
- ✅ Better user experience with streaming media
- ✅ Efficient bandwidth usage with progressive loading

### ✏️ Media Rename Functionality
...
- ✅ Easy user-specific media management
- ✅ Data-driven insights with statistics
...
**Administration**:
- Access via Admin → Media → Orphaned Files tab
...
**Administration**:
- Configure via Admin → Server → Appearance
...
- ✅ Multiple stylesheets for modular customization
...
**Benefits**:
- ✅ Prevents accidental deletion of in-use files
...
> [!WARNING]
> **CRITICAL: DO NOT USE THIS MIGRATION**
> 
> The migration in v0.6.0 contains a critical bug that will cause deployment failure. Please upgrade directly to v0.6.1 instead, which contains a fixed migration. See [Incident Report](./incidents/2025-11-12-v0-6-0-migration-failure.md) for details.
...
**⚠️ Migration Bug**: The v0.6.0 migration fails due to issues with adding the `created_by_id` column to existing `media` tables. This has been fixed in v0.6.1.

**Migration Steps** (for reference only - **DO NOT USE v0.6.0**):
...
**Instead**: Upgrade directly to v0.6.1 which contains the corrected migration.
...
- ✅ Default policies are applied (10 GB per user, 20 MB upload limit)
- ✅ Appearance settings default to empty (no custom stylesheets)
- ✅ Media usage tracking is automatically enabled
- ✅ No configuration changes needed immediately

### New Features Setup

**User Media Drive**:
- Accessible from User menu → Media Drive
...
- Accessible via Admin → Media → Orphaned Files tab
...
- ✅ File preview displays correctly for all types
...
- ✅ Unlimited options work correctly
- ✅ Audio/video streaming works
- ✅ Preview functionality works

### Admin Media Management
- ✅ System-wide view displays correctly
...
### CSS Customization
- ✅ Stylesheets are injected correctly
- ✅ Ordering works for cascade
- ✅ URL validation works
- ✅ Changes take effect immediately

### Media Usage Tracking
- ✅ Usage detection is accurate
- ✅ Deletion protection works
- ✅ HTML parsing works correctly
- ✅ Relationship tracking is automatic
