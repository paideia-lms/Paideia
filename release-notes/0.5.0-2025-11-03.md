...
**Version:** 0.5.0
**Type**: New Features
**Impact**: High - Introduces comprehensive features for course management, quiz systems, grading, user management, and administrative tools
**Changelog**: 0001-0031
...
### 🔄 Activity Module Access Control
...
### Quiz Builder
- ✅ Fixed React hydration errors from nested buttons
- ✅ Fixed page break conversion logic for empty pages
- ✅ Fixed drag-and-drop height distortion with DragOverlay
- ✅ Fixed @dnd-kit hydration mismatch with client-only rendering

### Notes Page
- ✅ Fixed timezone discrepancy causing wrong date filtering
- ✅ Fixed date parsing inconsistencies with safe date utilities
- ✅ Improved component organization and query state management

### Form Data Parsing
- ✅ Fixed form data parser failure in Bun compiled mode
- ✅ Added automatic fallback to native FormData API
- ✅ Maintained backward compatibility with existing upload handlers

### Native Dependency Check
- ✅ Fixed relative import detection in check script
- ✅ Improved package analysis with multiple detection methods
...
### Registration Route
- **Route change**: `/first-user` → `/registration`
